...
@Component
@CrossOrigin
public class VendorServiceRestController   extends SpringBootServletInitializer {

    private static final Logger LOGGER = LoggerFactory.getLogger(VendorServiceRestController.class);
